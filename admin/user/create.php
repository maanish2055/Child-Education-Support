...
//variable store
$first_name=$middle_name=$last_name=$email=$password=$confirm_password=$mobile=$image=$role_id='';
...
$mobile =$_POST['mobile'];
    ...
    if (empty($email)){
       ...
       $checkEmailExists = mysqli_fetch_array($query);
    
       if (isset($checkEmailExists['email']) && $checkEmailExists['email'] == $email){
...
if(isset($_FILES['image']) && $_FILES['image']['name'] != ''){
 ...
 if($firstNameErr == '' && $lastNameErr == '' && $emailErr == '' && $passwordErr == '' && $mobileErr == '' &&$imageErr== ''){
    ...
    if($uploadImage){
        ...
        $mysql = mysqli_query($conn,"insert into user(email,first_name,middle_name,last_name,password,mobile,image,date) values('$email','$first_name','$middle_name','$last_name','$pass','$mobile','$fileName','$date')");
    }else{
       
        $mysql=mysqli_query($conn,"insert into user(email,first_name,middle_name,last_name,password,mobile,date) values('$email','$first_name','$middle_name','$last_name','$pass','$mobile','$date')");
    }
    if($mysql){
...
<div class="row border-bottom"> 
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to ces</span>
                </li>
                <li class="dropdown">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" name="user-registration">
                                <div class="form-group  row">
                                  ...
                                  <div class="form-group  row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="middle_name" value="<?php echo isset($middle_name)?$middle_name:''?>">
                                        </div>
                                </div>
                                 ...
                                 <div class="col-sm-10">
                                  ...
                                  <label class="col-sm-2 col-form-label">Contact Number</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="tel" class="form-control" name="mobile" maxlength="10" value="<?php echo isset($mobile)?$mobile:''?>">
